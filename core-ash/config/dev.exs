...
config :fleet_tracking, FleetTracking.Repo,
  url: System.get_env("DATABASE_URL") || "ecto://postgres:postgres@localhost/fleet_tracking_dev",
...
config :fleet_tracking, dev_routes: true, token_signing_secret: "32_RANDOM_CHARS_MINIMUM_FOR_SIGNING_SECRET_TEST"
